 ...
 * @endcode
 */
$settings['hash_salt'] = 'ZGVmYXVsdABGx20idzI=';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_rcwave_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_rcwave_dd.inc';
}
// </DDSETTINGS>
